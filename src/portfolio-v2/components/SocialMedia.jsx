import { FaEnvelope, FaGithub, FaLink, FaPhone, FaUserAlt } from 'react-icons/fa';

const SocialMedia = () => {
    const socialMediaLinks = [
        { title: 'Portfolio', href: 'https://emon-36659.web.app/', icon: <FaUserAlt /> },
        { title: 'Resume', href: 'https://drive.google.com/file/d/1hQmY5Qy-EIj50NPZd2TtHcUg-O9eXiJu/view?usp=sharing', icon: <FaLink /> },
        { title: 'Mobile', href: 'tel:+8801919371381', icon: <FaPhone /> },
        { title: 'Gmail', href: 'mailto:emon.hossain.web@gmail.com', icon: <FaEnvelope /> },
        { title: 'Github', href: 'https://github.com/emon-webdev', icon: <FaGithub /> },
    ...
    return (
        ...
        >
            ...
            <div
                className='right-icons fixed z-50 right-0'
            >
                <ul className=''>
                    <li>
                        <a class="social__link"
