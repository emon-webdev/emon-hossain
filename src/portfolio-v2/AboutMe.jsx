                ...
                <div class="flex items-center details py-16">
                    ...
                    <div class="md:basis-3/5 w-full md:ml-[60px] content-box">
                        <div class="flex title-icon-box justify-between mb-5">
                            ...
                            <div class="my-4">
                                <ul class="about-social hidden md:flex items-center">
                                    <li>
                        ...
                        <div class="md:flex border-t border-[#28dbd1] items-center justify-between py-[20px]"><div>
                            <h4 className='text-white mb-1'>Reviews:</h4>
                            <div class="flex text-yellow-400">
                                <spn>
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.595 6.252L8 1 6.405 6.252H1l4.373 3.4L3.75 15 8 11.695 12.25 15l-1.623-5.348L15 6.252H9.595z"></path></svg></spn><spn><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.595 6.252L8 1 6.405 6.252H1l4.373 3.4L3.75 15 8 11.695 12.25 15l-1.623-5.348L15 6.252H9.595z"></path>
                                    </svg></spn><spn>
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.595 6.252L8 1 6.405 6.252H1l4.373 3.4L3.75 15 8 11.695 12.25 15l-1.623-5.348L15 6.252H9.595z"></path>
                                    </svg>
                                </spn>
                                <spn>
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.595 6.252L8 1 6.405 6.252H1l4.373 3.4L3.75 15 8 11.695 12.25 15l-1.623-5.348L15 6.252H9.595z"></path>
                                    </svg></spn>
                                <spn><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.405 6.252L8 1l1.595 5.252H15l-4.373 3.4L12.25 15 8 11.695 3.75 15l1.623-5.348L1 6.252h5.405zM8 10.032l1.915 1.49-.731-2.41 1.915-1.49H8.732L8 5.214v4.82zm0-7.525zm5.652 4.215H9.28h4.372z"></path></svg>
                                </spn>
                            </div>
                        </div>
                            <div>
                        ...
                        <ul class="about-social  md:hidden flex justify-center items-center">
                            <li>
                                <a class="social__link"
                                    href="https://www.linkedin.com/in/emon-webdev/"
                                    target="_blank" rel="noreferrer"
