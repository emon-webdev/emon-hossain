...
const Footer = () => {
    return (
        <div
            className="footer-area bg-[#111121] "
            style={{
        ...
        >
            ...
            <div className="footer-copy text-center py-5 border-t-[1px] border-[#166662]">
                <p className='text-[16px] text-[#fff]'>© 2022 All Rights Reserved by <span className='text-[#28dbd1]'>Emon Hossain </span>.</p>
            </div>
        </div>
    );
};
