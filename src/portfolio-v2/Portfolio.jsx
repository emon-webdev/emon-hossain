                        ...
                        <TabPanels className='projects-tab-content'>
                            ...
                            <TabPanel className=''>
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    <div className="project-img md:basis-6/12">
                                        <img className='max-h-[370px] w-[400px] rounded' src={capitalTrust} alt="" srcset="" />
                                    </div>
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Capital Trust Bank</h2>
                                            <p className='text-white text-sm mb-5  font-semibold'>Banking Website || Team Project || 2 month duration</p>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    Have an Admin, User dashboard, Admin dashboard,  Admin can delete, add, manage products.
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                ...
                                                <span>
                                                    Technology: React, React Router, Tailwind, MongoDB, Express.js, Node.js, Private route, Firebase Authentication, etc
                                                </span>
                                            </li>
                                            <div className='project-btn flex flex-wrap gap-4'>
                                                <a className='primary-btn' href="https://capital-trust-bank-ee791.web.app/" target="_blank" rel="noopener noreferrer">
                                                    live link
                                                </a>
                                                <a className='primary-btn' href="https://github.com/emon-webdev/Capital-Trust-Bank" target="_blank" rel="noopener noreferrer">
                                                    Client Code
                                                </a>
                                                <a className='primary-btn' href="https://github.com/emon-webdev/Capital-Trust-Bank-Server" target="_blank" rel="noopener noreferrer">
                                                    Server Code
                                                </a>
                                            </div>
                                        </ul>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    <div className="project-img md:basis-6/12">
                                        <img className='max-h-[370px] w-[400px] rounded' src={carRelsel} alt="" srcset="" />
                                    </div>
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Car Resell</h2>
                                            <p className='text-white text-sm mb-5  font-semibold'>Car Resell Website</p>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                    <AiOutlineCheckCircle className='text-2xl mr-3 text-[#28dbd1]' />
                                                </span>
                                            ...
                                            <div className='project-btn flex flex-wrap gap-4'>
                                                <a className='primary-btn' href="https://car-showroom-520ff.web.app/" target="_blank" rel="noopener noreferrer">
                                                    live link
                                                </a>
                                                <a className='primary-btn' href="https://github.com/emon-webdev/car-showroom" target="_blank" rel="noopener noreferrer">
                                                    Client Code
                                                </a>
                                                <a className='primary-btn' href="https://github.com/emon-webdev/car-showroom-server" target="_blank" rel="noopener noreferrer">
                                                    Server Code
                                                </a>
                                            </div>
                                        </ul>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    <div className="project-img md:basis-6/12">
                                        <img className='max-h-[370px] w-[400px] rounded' src={clean} alt="" srcset="" />
                                    </div>
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Clean Service</h2>
                                            <p className='text-white text-sm mb-5  font-semibold'>Clean Service Provide</p>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                    <AiOutlineCheckCircle className='text-2xl mr-3 text-[#28dbd1]' />
                                                </span>
                                                <span>
                                                    This is a Clean Service Provide website.
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    Have an Admin, User, Seller dashboard. Admin can delete, add, manage products, comment
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                            ...
                                            <div className='project-btn flex flex-wrap gap-4'>
                                                <a className='primary-btn' href="https://cleaning-service-9d61e.web.app/" target="_blank" rel="noopener noreferrer">
                                                    live link
                                                </a>
                                                <a className='primary-btn' href="https://github.com/emon-webdev/cleaning-service" target="_blank" rel="noopener noreferrer">
                                                    Client Code
                                                </a>
                                                <a className='primary-btn' href="https://github.com/emon-webdev/cleaning-service-server" target="_blank" rel="noopener noreferrer">
                                                    Server Code
                                                </a>
                                            </div>
                                        </ul>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    This is a Front-End Air Booking Website
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                ...
                                                <span>
                                                    Front-End Base Booking Website
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            ...
                                            <p className='text-white text-sm mb-5  font-semibold'>Countries Filtering  Website</p>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                    <AiOutlineCheckCircle className='text-2xl mr-3 text-[#28dbd1]' />
                                                </span>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    Filtering  Using from Client Side
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                ...
                                                <span>
                                                    Technology: React, Rest APIs, Tailwind,
                                                </span>
                                            </li>
                                            <div className='project-btn flex flex-wrap gap-4'>
                            ...
                            <TabPanel className=''>
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>News Outlet</h2>
                                            <p className='text-white text-sm mb-5  font-semibold'>JavaScript Base Website</p>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                    <AiOutlineCheckCircle className='text-2xl mr-3 text-[#28dbd1]' />
                                                </span>
                                                <span>
                                                    This is a JavaScript Base Website.
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Player Select</h2>
                                            <p className='text-white text-sm mb-5  font-semibold'>Select Top 5 Player</p>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                    <AiOutlineCheckCircle className='text-2xl mr-3 text-[#28dbd1]' />
                                                </span>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    Per Player Budget, Player Select
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Gym Club</h2>
                                            <p className='text-white text-sm mb-5  font-semibold'>Gym Club Website</p>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                                                    <AiOutlineCheckCircle className='text-2xl mr-3 text-[#28dbd1]' />
                                                </span>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    Gym category Select, Gym Time Set , Gym Activity, Break time
                                                </span>
                                            </li>
                                            <li className='flex items-center text-white mb-4'>
                                                <span>
                            ...
                            <TabPanel className=''>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Lorem Ipsum is Simply Dummy</h2>
                                            ...
                                            <li className='flex items-center text-white mb-4'>
                                                ...
                                                <span>
                                                    Jquery:Slick Slider, Magnify pop, animate
                                                </span>
                                            </li>
                                            <div className='project-btn flex flex-wrap gap-4'>
                                ...
                                <div className='single-project md:flex mb-7  p-6 rounded bg-[#0a1f2f]'>
                                    ...
                                    <div className="project-content pt-3 my-4 md:my-0 md:basis-6/12 md:ml-8">
                                        <ul>
                                            <h2 className='text-white text-2xl font-bold'>Construction</h2>
