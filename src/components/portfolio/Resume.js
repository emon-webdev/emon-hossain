    ...
    <div className="container sm:px-5 md:px-10 lg:px-14">
      <div>
        <div className="py-12 px-4 md:px-0">
          <h2 className="font-bold text-[2.5rem]">Resume</h2>
          <div className="grid grid-cols-1  gap-x-6 gap-y-6 mt-[30px]">
            ...
            {/* <div>
              ...
              <div className="py-4 pl-5 pr-3 space-y-2 rounded-lg  mb-6 dark:border-[#212425] dark:border-2">
                <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">
                  2019 - Present
                </span>
              ...
              <div className="py-4 pl-5 pr-3 space-y-2 rounded-lg  dark:border-[#212425] dark:border-2">
                <span className="text-tiny text-gray-lite dark:text-[#b7b7b7]">
                  2021
                </span>
